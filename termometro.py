...
class Termometro():
    def __init__(self):
        self.custome = pygame.image.load("images/termo3.png")
...
class mainApp():
    ...
    def start(self):
        while True:
            ...
            self.__screen.blit(self.termometro.custome, (-25, 34))
            #Pintamos el cuadro de texto
            text = self.entrada.render() #Obtenemos rectangulo y foto de texto y lo asignamos a la variable text
            ...
            pygame.display.flip()#resfreco pantalla
